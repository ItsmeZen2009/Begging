...
yes.addEventListener("click", () => {
  ...
  text.innerHTML = "Thankssss 😘";
  yes.innerHTML = '<a href="https://www.instagram.com/holy_zennn?igsh=MXhkNjZ1YjE1YWMyZw==">Message me na🙏😽</a>';// inside the " " put your social media profile link
  yes.style.height = "90%";
  yes.style.width = "96%";
  no.style.display = "none";
  setTimeout(() => {
